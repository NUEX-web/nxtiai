...
// Each entry maps to a real, working capability -- either a writing mode
// supported by the editor (see lib/modes.ts) or a standalone page. Kept in
// sync with the same product list in Footer.tsx and ToolsSection.tsx.
const PRODUCT_LINKS: ProductLink[] = [
  ...
  { label: "Grammar Checker", description: "Catch grammar and punctuation issues", href: "/?mode=grammar-checker#workspace" },
  { label: "AI Detector", description: "Check whether text reads as AI-written", href: "/ai-detector" },
];
